...
building <span className="italic">scalable web applications</span>. My focus is{" "}
<span className="underline">web development with DevOps-powered scalability</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://github.com/shravan341"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
